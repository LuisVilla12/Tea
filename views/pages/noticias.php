...
<main class="noticias contenedor">
    <div class="noticias__grid contenedor">
        <section class="notice">
            <div class="notice__mask">
                <img src="/build/img/portada1.jpg">
            </div>
            <div class="notice__contenido">
                <h2>DÍA MUNDIAL DEL AUTISMO</h2> 
                <div class="notice__meta">
                    <p class="notice__fuente">Fuente: Teleton Mexico</p>
                    <p class="notice__fecha">Fecha:2 de abril del 2022</p>
                </div>
                ...
                <div class="centrar">            
                    <a class="notice__btn" href="https://teleton.org/que-es-el-autismo/?gclid=CjwKCAiA9tyQBhAIEiwA6tdCrNBZXl3BPHUPe7la6_jgX5jUNTD46tn2XSJxp7JkEE0WQnRIlojjthoCifcQAvD_BwE">Leer más</a>
                </div>
            </div>           
        </section>
        <section class="notice">        
            ...
            <div class="notice__contenido">
                <h2>Autismo: Cuando el agresor es el Estado, el culpable eres tú</h2>
                <div class="notice__meta">
                    <p class="notice__fuente">Fuente: Autismo diario</p>
                    <p class="notice__fecha">Fecha:7 de abril del 2022</p>
                </div>
                ...
                <div class="centrar">            
                <a class="notice__btn" href="https://autismodiario.com/2021/07/18/autismo-cuando-el-agresor-es-el-estado-el-culpable-eres-tu/">Leer más</a>            
                </div>
            </div>
        </section>
        <!-- <section class="notice">
        ...
        <section class="notice">
            ...
            <div class="notice__contenido">
                <h2>Descubrieron que se podía comunicar a través de la música y hoy lidera una banda</h2>
                <div class="notice__meta">
                    <p class="notice__fuente">Fuente: infabae</p>
                    <p class="notice__fecha">Fecha: 11 de abril del 2022</p>
                </div>
                ...
                <div class="centrar">            
                <a class="notice__btn" href="https://www.infobae.com/sociedad/2022/04/11/tiene-autismo-descubrieron-que-se-podia-comunicar-a-traves-de-la-musica-y-hoy-lidera-una-banda/">Leer más</a>
                </div>
            </div>
        </section>
        <section class="notice">
            ...
            <div class="notice__contenido">
                <h2>Me diagnosticaron autismo a los 60 años</h2>
                <div class="notice__meta">
                    <p class="notice__fuente">Fuente: infabae</p>
                    <p class="notice__fecha">Fecha: 11 de abril del 2022</p>
                </div>
                ...
                <div class="centrar">
                <a class="notice__btn" href="https://www.bbc.com/mundo/noticias-61076259">Leer más</a>
                </div>                
            </div>
            </section>
        <section class="notice">
            ...
            <section class="notice">
                ...
                <div class="notice__contenido">
                    <h2>24 de abril: RUTA AUTISMO SOMOS TODOS 2022</h2>
                    ...
                    <div class="centrar">
                        <a class="notice__btn" href="https://www.lineadesalida.net/carreras/ruta-autismo-somos-todos-2022" class="noticia__notice__btn">Leer más</a>
                    </div>
                </div>
            </section>
    </div>
